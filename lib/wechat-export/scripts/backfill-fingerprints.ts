...
//
//   npx tsx lib/wechat-export/scripts/backfill-fingerprints.ts [--dry-run]            local D1 (the dev server's)
//   npx tsx lib/wechat-export/scripts/backfill-fingerprints.ts --remote [--env <name>] [--dry-run]   deployed D1 via wrangler
//

...
import { GENERATED_PATH, loadPromptFiles, renderGenerated } from '~/scripts/extract/gen-prompts'
...
describe('prompt files', () => {
  it('generated module is in sync with prompts/*.md (run scripts/extract/gen-prompts.ts)', () => {
